...
const ButtonSendVerifyOTP = ({ className, isDisabled, Title, HandleVerifyOTP }: ButtonProps) => {
  const context = useContext(UserContext);

  // Ensure context is defined
  if (!context) {
    throw new Error("ButtonSendVerifyOTP  must be used within a UserContextProvider");
  }
...
export default ButtonSendVerifyOTP;
