...
export const StoreBanner = () => {
  return (
    <div className="relative w-full h-[250px] md:h-[400px] rounded-xl overflow-hidden grid place-items-center">
      <Image src='https://res.cloudinary.com/dju3jontk/image/upload/q_100/v1733758365/store_banner_upscaled_tcqbrv.webp' height={100} width={100} quality={100} className="w-full h-full absolute top-0 object-cover lg:object-contain z-0" alt="BannerImage" sizes="100vw" />
