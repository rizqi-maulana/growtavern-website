...
export const MainBanner = () => {
  return (
    <div className="relative xl:w-[70%] w-full h-max xl:h-[400px] rounded-xl overflow-hidden">
      <Image src='https://res.cloudinary.com/dju3jontk/image/upload/q_100/v1733408241/main_banner_rpb6fy.webp' width={100} height={100} className="w-full h-full absolute top-0 object-cover z-0" alt="BannerImage" sizes="100vw" />
